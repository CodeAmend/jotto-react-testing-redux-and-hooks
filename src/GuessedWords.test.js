...
* @function setup
* @param {array} guessedWords - Array of guessedWords objects
...
const setup = (guessedWords=[]) => {
  ...
  guessWordsContext.useGuessedWords = mockUseGuessedWords;
...
describe('languagePicker', () => {
  ...
  test('correctly renders guess instructions string in emoji', () => {
    ...
    React.useContext = mockUseContext.mockReturnValue('emoji');
